                                ...
                                <div class="panel-hdr align-content-center justify-content-center p-2">
                                    <div class="d-flex col-gap-6 fs3" id="servers-charts">
                                        ...
                                        <a class="nav-link">
                                            ...
                                            <p class="text-dark">Servidor <?=$i+1?></p>
                                        </a>
                                        <?php endfor; ?>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-5 panel panel-content mx-auto px-1 py-4 pr-0">
                                            <div class="row row-cols-3 col-12 align-items-center justify-content-between pr-0">
                                                ...
                                                <div class="col-2">
                                                        ...
                                                        <div class="modal-dialog modal-position">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h2 class="modal-title" id="exampleModalToggleLabel">Nombre del servidor <?=$x+1;?></h2>
                                                                            ...
                                                                            <div class="panel-content row">                                                        
                                                                                <div class=" panel col-4 m-auto">
                                                                                    ...
                                                                                    <table class="table mt-2">
                                                                                        ...
                                                                                        <tbody class="text-center" id="alertas">                                                                                
                                                                                        </tbody>
                                                                                    </table>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="mt-3 col-12">
                                                                                        ...
                                                                                        <h5>Servicios</h5>
                                                                                            <table class="table mt-5">
                                                                                                ...
                                                                                                <tbody class="text-center" id="servicios" data-servidor="servidor-<?=$x?>">                                                                                            
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </div>
                                                                                    </div>
                                                    ...
                                                    <a class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle" role="button" data-id="<?=$x?>"><i class="fal fa-search"></i></a>
                                                </div>
                                            </div>
                                        </div>
